package com.thesis.cms.common.directive;
...
import com.thesis.cms.util.DirectiveUtil;
...
public class PermistionDirective implements TemplateDirectiveModel {
	...
	private TemplateSequenceModel getPerms(Environment env) throws TemplateModelException {
		TemplateModel model = env.getDataModel().get(com.thesis.cms.util.Constants.PERMISSION_MODEL);
		if (model == null) {
			return null;
		}
